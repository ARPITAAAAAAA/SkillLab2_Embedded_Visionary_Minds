...
TOUCH_SENSOR = 22  # Touch sensor pin

GPIO.setup(IR_LEFT, GPIO.IN)
GPIO.setup(IR_RIGHT, GPIO.IN)
GPIO.setup(TOUCH_SENSOR, GPIO.IN)

# --- PHYSICAL START TRIGGER ---
print("SYSTEM LOCKED: Touch the sensor at GPIO 22 to initialize...")
while True:
    if GPIO.input(TOUCH_SENSOR) == GPIO.HIGH:
        print("\n[START] Touch Detected! Initializing System...")
        break
    time.sleep(0.1)

# --- 2. AI MODELS (LOCAL PATHS) ---
cascade_path = os.path.join(base_dir, "haarcascade_frontalface_default.xml")
proto_path = os.path.join(base_dir, "age_deploy.prototxt")
...
# Threads start ONLY after the touch sensor trigger above
